...
timer.Create("cslua_initalize",5,5,function()
	if LocalPlayer() and GetUserGroup and LocalPlayer():GetUserGroup() then
		timer.Remove("cslua_initalize")
	...
	elseif timer.RepsLeft("cslua_initalize")==1 then
		print("LocalPlayer():GetUserGroup()=nil")
	end
end)