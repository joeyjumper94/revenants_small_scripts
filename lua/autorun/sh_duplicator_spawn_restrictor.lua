...
hook.Add("CanTool","duplicator_restrictor",function(ply,trace,tool)
	if ply and tool then
		if tool=="duplicator" and !ply:CheckGroup(RANK) and !ply:IsSuperAdmin() and !ply:KeyPressed(IN_ATTACK2) and RANK!="nil" and RANK!="" and RANK!="none" and tobool(RANK) then
